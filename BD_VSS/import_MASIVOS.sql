...
-- 2. Cargar CSV
\COPY temp_pescados_mariscos FROM '/Users/claudioandressanmartinconcha/Desktop/pescaos_y_mariscos.csv' WITH (FORMAT csv, DELIMITER ';', HEADER true, ENCODING 'UTF-8');
